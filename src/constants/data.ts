...
export const experienceItems = {
  'Blue Bird Group': {
    ...
    desc: [
      'Initiated and built the integration of Kit Analytics, an internal product analytics platform for event tracking, user behavior, and funnel analysis — from inception to rollout across engineering teams.',
      'Currently dedicated to the finance squad, contributing end-to-end payment business processes and integrations with third-party services such as banks and other financial partners.',
      'Implemented Spec-Driven Development (SDD) practices to align frontend and backend teams on API contracts, reducing integration mismatches and accelerating feature delivery.',
      'Contributed to the transition to a micro-frontend architecture using Nx and Vite, building reusable modules and supporting deployment across multiple engineering squads.',
      'Helped architect and maintain the internal UI Library (KitBird) and Webservice APIs, standardizing components and contributing to documentation for company-wide frontend workflows.',
      'Supported engineering standards through code reviews, technical sharing sessions, and Jest/Vitest unit testing pipelines, achieving over 80% code coverage.',
    ],
    jobTitle2: '',
    duration2: '',
    desc2: [] as string[],
